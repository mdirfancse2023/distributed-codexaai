...
CODEXA_APP_HOST           codexaai.virtualgyans.me
CODEXA_API_HOST           codexaapp.virtualgyans.me
CODEXA_PREVIEW_DOMAIN     previews.virtualgyans.me
CODEXA_API_URL            https://codexaapp.virtualgyans.me
...
if [[ -n "$INGRESS_IP" ]]; then
  ...
  echo "============================================================"
  echo "  CODEXA_APP_HOST:       codexaai.virtualgyans.me"
  echo "  CODEXA_API_HOST:       codexaapp.virtualgyans.me"
  echo "  CODEXA_PREVIEW_DOMAIN: previews.virtualgyans.me"
  echo "  CODEXA_API_URL:        https://codexaapp.virtualgyans.me"
  echo "============================================================"
else
